              ...
              {kollamCategories.map((category, index) => {
                ...
                return (
                  <motion.button
                    ...
                    className="bg-neutral-950 rounded-2xl shadow-md border border-neutral-800/80 hover:border-amber-400 p-5 flex flex-col justify-end text-left transition-all duration-300 group aspect-[4/3] sm:aspect-square relative overflow-hidden hover:shadow-xl hover:scale-[1.02] cursor-pointer"
                  >

      ...
      <section id="gallery" className="py-24 bg-slate-50">
        <motion.div {...scrollFadeUp} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-serif text-slate-900 mb-12">Gallery</h3>
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-12">
              {GALLERY_CATEGORIES.map(category => (
                <button
                  ...
                  className={`px-5 py-2 rounded-full text-sm font-bold uppercase tracking-wider transition-colors border ${
                    activeGallery === category 
                      ? "bg-teal-700 border-teal-700 text-white" 
                      : "bg-white border-teal-700/20 text-teal-700 hover:border-teal-700"
                  }`}
                >
                  {category}
                </button>
            ...
            <AnimatePresence>
              {filteredGallery.map(img => (
                <motion.div
                  ...
                  className="group relative aspect-square rounded-2xl overflow-hidden bg-neutral-200"
                >
        ...
        <motion.div {...scrollFadeUp} className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-12">
                ...
                <div>
                  ...
                  <a 
                    href="https://maps.app.goo.gl/KJrpazh74hz8UTGu6?g_st=aw"
                    target="_blank"
                    rel="noreferrer"
            ...
            <div className="relative rounded-[24px] overflow-hidden border border-teal-700/20 aspect-square lg:aspect-auto">
              <iframe 
                src="https://maps.google.com/maps?q=Asado%20Alappuzha&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
